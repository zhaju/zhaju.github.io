...
Adrian Reetz
TST: M 10/28 7:00-8:50PM
TUT F 1:30-2:20PM MC 1056 TBA
LEC TTh 11:30-12:50PM EC 1736 
...
# 0 | Overview 
- Racket (no loops, doing recursively) which is useless
- Recursion: Simple, accumulative, general, mutual
- Structures (like objects)
- Trees (binary, binary search, arithmetic abstraction)
- Functional Abstraction (lambda expressions, abstract list function like filter, map, foldr, foldl, buildlist)
- Graphs (backtracking, shortest path)
- Hard questions (especially in Racket) - beware question 3b
- 13-19 hr / wk
# 1 | Syllabus
Course Themes
- Design (creation)
